...
rispetto alla percentuale calcolata nel punto 8. In particolare, il logaritmo 
naturale della percentuale di lista è stato fatto variare secondo una 
distribuzione normale con deviazione standard `r variab`, e i valori così 
ottenuti sono stati riconvertiti in percentuali attraverso la funzione softmax.
...
andando a ripescare candidati non eletti anche da altre regioni). Non sono stati
simulati i seggi delle circoscrizioni Estero e Valle d'Aosta.
