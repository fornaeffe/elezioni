...
# Genero i parametri per la simulazione
parametri_simulazione <- calcola_parametri_di_voto(dati, scenario)
...
elettori <- sum(parametri_simulazione$comuni_liste$ELETTORI[parametri_simulazione$comuni_liste$LISTA == "astensione"])
...
lista_elezione <- merge(
  parametri_simulazione$liste_elezioni,
  liste[, c("LISTA", "COLORE")],
  by = "LISTA"
)
