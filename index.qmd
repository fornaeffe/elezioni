...
# Scenario
scenario <- "demopolis_zeropluricand"
...
- Coalizioni più probabili a oggi
...
disegna_tabella_pluri <- function(ramo) {
  ...
  tbl <- tbl[order(tbl[[lista]], decreasing = TRUE), ]
...
#### Probabilità di elezione in ciascuna posizione di ciascun collegio

```{r}
disegna_tabella_prob <- function(ramo) {
  lp <- get(ramo)$risultato$liste_pluri
...
disegna_tabella_prob("camera")
disegna_tabella_prob("senato")
