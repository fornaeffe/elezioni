...
carica_dati <- function(ramo) {
  ...
  list(uni = uni, pluri = pluri)
}

camera <- carica_dati("camera")
senato <- carica_dati("senato")

# Check per controllare che i nomi corrispondano
setdiff(camera$uni$CIRCOSCRIZIONE, base_dati$CIRCOCAM_20_DEN)
setdiff(base_dati$CIRCOCAM_20_DEN, camera$uni$CIRCOSCRIZIONE)

setdiff(camera$pluri$CIRCOSCRIZIONE, base_dati$CIRCOCAM_20_DEN)
setdiff(base_dati$CIRCOCAM_20_DEN, camera$pluri$CIRCOSCRIZIONE)

setdiff(senato$uni$CIRCOSCRIZIONE, base_dati$DEN_REG20)
setdiff(base_dati$DEN_REG20, senato$uni$CIRCOSCRIZIONE)

setdiff(senato$pluri$CIRCOSCRIZIONE, base_dati$DEN_REG20)
setdiff(base_dati$DEN_REG20, senato$pluri$CIRCOSCRIZIONE)



setdiff(camera$uni$COLLEGIOUNINOMINALE, base_dati$CU20_DEN)
setdiff(base_dati$CU20_DEN, camera$uni$COLLEGIOUNINOMINALE)

setdiff(camera$pluri$COLLEGIOPLURINOMINALE, base_dati$CP20_DEN)
setdiff(base_dati$CP20_DEN, camera$pluri$COLLEGIOPLURINOMINALE)

setdiff(senato$uni$COLLEGIOUNINOMINALE, base_dati$SU20_DEN)
setdiff(base_dati$SU20_DEN, senato$uni$COLLEGIOUNINOMINALE)

setdiff(senato$pluri$COLLEGIOPLURINOMINALE, base_dati$SP20_DEN)
setdiff(base_dati$SP20_DEN, senato$pluri$COLLEGIOPLURINOMINALE)
